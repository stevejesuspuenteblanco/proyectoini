<?php
 include 'panelcatalogo/inc/functionBD.php';
    ...
    $base = new GestarBD();
    $user=$_GET["valor"];
    $consulta="SELECT * FROM pagina where idusuario=$user limit 1";
    ...
    <?php
      ...
      if ($pagina=$base->mostrar_registros()) {
...
?>
 <strong><h2 class="titulo-portada"><?php echo $pagina->titulo; ?></h2></strong>
   ...
   <div class="desc-portada">
        <span><p><?php echo $pagina->descripcion; ?>.</p></span>
      </div>
    </div>
  </div>
  </div>
...
<div class="contenedor">
    ...
    <?php
      ...
      $respuesta=$categoria->consulta($consulta);
      $indexWhile=0;
      while ($fila=$categoria->mostrar_registros($respuesta)) {
    ?>
